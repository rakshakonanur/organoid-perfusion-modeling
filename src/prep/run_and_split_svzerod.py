...
def parse_args() -> argparse.Namespace:
    ...
    ap.add_argument("--input", type=str, default="/Users/rakshakonanur/Documents/Research/Organoid-Project/coupled-multi-organoid-model/src/coupling-output/run_20/combined.in", help="Input .in/.json file for svzerodsolver")
    ap.add_argument("--outdir", type=str, default="/Users/rakshakonanur/Documents/Research/Organoid-Project/coupled-multi-organoid-model/src/coupling-output/run_20", help="Output directory (cwd for solver, and where split/ is created)")
